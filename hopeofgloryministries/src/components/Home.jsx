      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <div className="lg:flex-row flex-col-reverse flex justify-center items-center">
          <div className="text-center lg:text-left lg:w-6/8">
            ...
            <h1 className="text-4xl sm:text-7xl font-bold text-white coolFont">
              Hope Of Glory Ministries
            </h1>
            <p className="text-white font-bold py-4 max-w-[700px] ">
              As a ministry committed to glorifying Jesus Himself; The vision
              and pillars given to Hope of Glory ministries by The Lord
              are : Jesus' Presence, power evangelism, healing & impartation, as
              well as equipping The Church, Through the facilitation and
              contexts of the local Church, the international Church, Bible
              colleges conferences, missions and the market place.
            </p>
            {/* Button */}
            <br></br>
            <div className="flex justify-end">
              {" "}
              {/* Use flex justify-end to push the button to the right */}
